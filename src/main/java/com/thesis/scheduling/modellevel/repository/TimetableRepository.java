...
public interface TimetableRepository extends CrudRepository<Timetable, String> {
	...
	Collection<Timetable> findByYearsAndSemesterAndCourseIdAndCourseTypeAndGroupId(String years, String semester,
	...
	Collection<Timetable> findAllByYearsAndSemesterAndCourseIdAndCourseTypeAndGroupIdAndMemberId(String years, String semester,
	...
	Optional<Timetable> findByYearsAndSemesterAndCourseIdAndGroupIdAndCourseTypeAndMemberId(String years, String semester,
