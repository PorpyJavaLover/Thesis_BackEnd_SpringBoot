...
public class TimetableAPIController {
	...
	public ResponseEntity<Iterable<M_Timetable_ShowTimeRemain_Response>> showStartTimeForSelection(@PathVariable("yId") String yId,
			@PathVariable("sId") String sId, @PathVariable("cId") Long cId, @PathVariable("cType") Integer cType, @PathVariable("gId") Long gId,
			@PathVariable("dayOfWeek") Integer dayOfWeek, @PathVariable("endTime") String endTime)
			throws BaseException {
		Iterable<M_Timetable_ShowTimeRemain_Response> response = timetableLogic.showStartTimeStaff(yId, sId, cId, cType, gId,
				dayOfWeek, endTime);
		return ResponseEntity.ok(response);
	}

	@GetMapping("/staff/show/end/time/{yId}/{sId}/{cId}/{cType}/{gId}/{dayOfWeek}/{startTime}")
	public ResponseEntity<Iterable<M_Timetable_ShowTimeRemain_Response>> showEndTimeForSelection(@PathVariable("yId") String yId,
			@PathVariable("sId") String sId, @PathVariable("cId") Long cId, @PathVariable("cType") Integer cType, @PathVariable("gId") Long gId,
			@PathVariable("dayOfWeek") Integer dayOfWeek, @PathVariable("startTime") String startTime)
			throws BaseException {
		Iterable<M_Timetable_ShowTimeRemain_Response> response = timetableLogic.showEndTimeStaff(yId, sId, cId, cType,  gId,
				dayOfWeek, startTime);
		return ResponseEntity.ok(response);
	}

	@GetMapping("/staff/show/room/{yId}/{sId}/{cId}/{cType}/{gId}/{dayOfWeek}/{startTime}/{endTime}")
	public ResponseEntity<Iterable<M_For_Selection_Response>> showRoomForSelection(@PathVariable("yId") String yId,
			@PathVariable("sId") String sId, @PathVariable("cId") Long cId, @PathVariable("cType") Integer cType, @PathVariable("gId") Long gId,
		...
		Iterable<M_For_Selection_Response> response = timetableLogic.showRoomStaff(yId, sId, cId, cType, gId,
	...
	public void deleteTeacherForPlan(@PathVariable("yId") String yId, @PathVariable("sId") String sId,
			@PathVariable("cId") Long cId, @PathVariable("cType") Integer cType , @PathVariable("gId") Long gId) throws BaseException {
	...
	public void deleteStaffForPlan(@PathVariable("yId") String yId, @PathVariable("sId") String sId,
			@PathVariable("cId") Long cId, @PathVariable("cType") Integer cType , @PathVariable("gId") Long gId, @PathVariable("memberId") Integer memberId)
			throws BaseException {
